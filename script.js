...
function alterar (){
    ...
    var img= $('.js-product-slide-img');
    $('.product-img').attr('src', '//d3ugyf2ht6aenh.cloudfront.net/stores/001/007/019/products/7m-boots-26-04-21-28-b1-7194c2f0a71d42a81216195383856463-480-0.webp 480w, //d3ugyf2ht6aenh.cloudfront.net/stores/001/007/019/products/7m-boots-26-04-21-28-b1-7194c2f0a71d42a81216195383856463-640-0.webp 640w, //d3ugyf2ht6aenh.cloudfront.net/stores/001/007/019/products/7m-boots-26-04-21-28-b1-7194c2f0a71d42a81216195383856463-1024-1024.webp 1024w">');
    var img= $('.js-product-slide-img');
    $('.product-img').attr('src', img);


    //VALOR NO PIX//
    var precipix= $('.js-price-display').html();
    $('.js-bar-display').html(precipix);

    //VALOR A VISTA//
    var text= $('#compare_price_display').text();
    $('.js-compare-bar-price-display').html(text);
    ...
    // PREÇO PARCELADO //
    var preco= $('.js-installment-price').html();
    $('.price-bar').html(preco);
